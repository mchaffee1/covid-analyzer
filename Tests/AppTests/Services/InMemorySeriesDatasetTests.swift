...
class InMemorySeriesDatasetTests: XCTestCase {
    ...
    func eightDaySequence(forState state: String? = nil, forFips fips: String? = nil) -> [RawLoadableRow] {
        ...
        return [
            RawStateRow(date: IsoDate(isoString: "2020-01-01"),
                        state: state,
                        fips: fips,
                        cases: 10,
                        deaths: 10),
            RawStateRow(date: IsoDate(isoString: "2020-01-02"),
                        state: state,
                        fips: fips,
                        cases: 20,
                        deaths: 10),
            RawStateRow(date: IsoDate(isoString: "2020-01-03"),
                        state: state,
                        fips: fips,
                        cases: 30,
                        deaths: 10),
            RawStateRow(date: IsoDate(isoString: "2020-01-04"),
                        state: state,
                        fips: fips,
                        cases: 40,
                        deaths: 15),
            RawStateRow(date: IsoDate(isoString: "2020-01-05"),
                        state: state,
                        fips: fips,
                        cases: 50,
                        deaths: 20),
            RawStateRow(date: IsoDate(isoString: "2020-01-06"),
                        state: state,
                        fips: fips,
                        cases: 60,
                        deaths: 20),
            RawStateRow(date: IsoDate(isoString: "2020-01-07"),
                        state: state,
                        fips: fips,
                        cases: 70,
                        deaths: 20),
            RawStateRow(date: IsoDate(isoString: "2020-01-08"),
                        state: state,
                        fips: fips,
                        cases: 150,
                        deaths: 80),
